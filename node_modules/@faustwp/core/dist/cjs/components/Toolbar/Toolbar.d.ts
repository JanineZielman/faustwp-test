 ...
 */
export declare type MenuLocation = 'primary' | 'secondary';
/**
 * A single Faust Toolbar node.
 */
export declare type FaustToolbarNode = {
    /**
 ...
 */
export declare type FaustToolbarNodes = FaustToolbarNode[];
/**
 * Toolbar context.
 */
export declare type FaustToolbarContext = {
    seedNode?: SeedNode;
};
/**
 * Toolbar props.
 ...
 */
export declare function AuthenticatedToolbar({ seedNode }: ToolbarProps): JSX.Element;
/**
 ...
 */
export declare function ToolbarAwaitUser({ seedNode }: ToolbarProps): JSX.Element | null;
/**
 * Renders a Toolbar that is based on WordPress' own toolbar.
 */
export declare function Toolbar({ seedNode }: ToolbarProps): JSX.Element | null;
